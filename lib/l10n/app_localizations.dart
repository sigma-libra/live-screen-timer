...
abstract class AppLocalizations {
  ...
  /// Description shown on the setup screen
  ///
  /// In en, this message translates to:
  ...
  /// Subtitle shown when timer is running
  ///
  /// In en, this message translates to:
  /// **'Resets each time you unlock'**
  String get resetsEachUnlock;

  /// Label above the notification preview widget
  ///
  /// In en, this message translates to:
  /// **'NOTIFICATION PREVIEW'**
  String get notificationPreview;

  /// Warning about battery optimization
  ///
  /// In en, this message translates to:
